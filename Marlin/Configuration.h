...
#define STRING_VERSION_CONFIG_H "Oct 21 2014" // build date and time
#define STRING_CONFIG_H_AUTHOR "MakerFarm Inc., Prusa 8\" i3v Kit" // Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,4000,841}  // default steps per unit for MakerFarm Prusa 8" i3v
